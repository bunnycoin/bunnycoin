...
DEFINES += QT_GUI QT_DEPRECATED_WARNINGS BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE
...
defined(OPENSSL_SOVERSION, var) {
    LIBS += -l:libssl.so.$$OPENSSL_SOVERSION -l:libcrypto.so.$$OPENSSL_SOVERSION
} else {
    LIBS += -lssl -lcrypto
}
