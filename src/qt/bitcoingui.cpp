    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Bunnycoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bunnycoin address"));
    ...
    voteCoinsAction = new QAction(QIcon(":/icons/voting_prefs"), tr("Charity &Voting"), this);
    voteCoinsAction->setStatusTip(tr("Vote in BunnyCoin elections"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Bunnycoin"), this);
    aboutAction->setStatusTip(tr("Show information about Bunnycoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Bunnycoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bunnycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bunnycoin addresses"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu *voting = appMenuBar->addMenu(tr("Charity &Voting"));
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    currentCandidatesAction->setEnabled(enabled);
    howToVoteAction->setEnabled(enabled);
    currentCandidatesAction->setEnabled(enabled);
}
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Bunnycoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    if(count<5){
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BunnyCoin network. Open port 48445 for more connections.", "", count));
    }else{
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bunnycoin network", "", count));
    }
}
...
{
    QString strTitle = tr("Bunnycoin"); // default title
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::BUN, nFeeRequired));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Bunnycoin address or malformed URI parameters."),
...
//	openWebsite(""+getDefaultWalletAddress());
}

void BitcoinGUI::howToVote(){
    openWebsite("http://bunnycoin.org/how-to-vote/");
}

void BitcoinGUI::currentCandidates(){
    openWebsite("http://bunnycoin.org/current-candidates/");
}

void BitcoinGUI::currentResults(){
    openWebsite("http://bunnycoin.org/election-results");
}
