...
#if defined(BUNNYCOIN_STATIC_WINDOWS_PLUGIN)
#include <QtPlugin>
...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Bunnycoin");
    QApplication::setOrganizationDomain("bunnycoin-noexist-domain.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Bunnycoin-Qt-testnet");
    else
        QApplication::setApplicationName("Bunnycoin-Qt");
