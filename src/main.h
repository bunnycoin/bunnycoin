...
static const int64 MAX_MONEY = 10000000000 * COIN; // BunnyCoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // BunnyCoin: 1440 blocks found a day. Priority cutoff is 100 bunnycoin day / 250 bytes.
    }
 ...
 *               * 8358: compact amount representation for 60000000000 (600 BUN)
 ...
 *             * 86ef97d579: compact amount representation for 234925952 (2.35 BUN)
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint160
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 BUN)
 *              * 00: special txout type pay-to-pubkey-hash
...
std::string electOrEliminate(int64 droopQuota,  unsigned int requiredCandidates);
void electCandidate(std::string topOfThePoll, double gregorySurplusTransferValue,bool isLastCandidate);
void eliminateCandidate(std::string topOfThePoll,bool isLastCandidate);
void printBallots();
int64 GetGrantValue();
bool deSerializeGrantDB(std::string filename);
void openWebsite (std::string cpURL);
std::string getDefaultWalletAddress();
